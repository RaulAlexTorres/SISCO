var pJS = function (e, a) {
    ...
    a && Object.deepExtend(m, a), m.tmp.obj = {
            ...
            if (o <= m.interactivity.modes.bubble.distance) {
                if (0 <= t && "mousemove" == m.interactivity.status) {
                    if (m.interactivity.modes.bubble.size != m.particles.size.value)
                        if (m.interactivity.modes.bubble.size > m.particles.size.value) {
                            0 <= (n = c.radius + m.interactivity.modes.bubble.size * t) && (c.radius_bubble = n)
                        } else {
        ...
        s.addEventListener("load", function () {
            n.img.obj = s, n.img.loaded = !0, t.revokeObjectURL(i), m.tmp.count_svg++
        }), s.src = i
    }, m.fn.vendors.destroypJS = function () {
        cancelAnimationFrame(m.fn.drawAnimFrame), t.remove(), pJSDom = null
    }, m.fn.vendors.drawShape = function (e, a, t, i, s, n) {
        var r = s * n,
            c = s / n,
            o = 180 * (c - 2) / c,
        ...
        if (m.tmp.img_error = void 0, "" != m.particles.shape.image.src)
            if ("svg" == e) {
                ...
                a.open("GET", m.particles.shape.image.src), a.onreadystatechange = function (e) {
                    4 == a.readyState && (200 == a.status ? (m.tmp.source_svg = e.currentTarget.response, m.fn.vendors.checkBeforeDraw()) : m.tmp.img_error = !0)
                }, a.send()
            } else {
                var t = new Image;
...
Object.deepExtend = function (e, a) {
    ...
    if (s.length)
        for (; 0 < s.length;) t.removeChild(s[0]);
    var n = document.createElement("canvas");
    n.className = i, n.style.width = "100%", n.style.height = "100%", null != document.getElementById(e).appendChild(n) && pJSDom.push(new pJS(e, a))
